...
<template>
  <div class="lg:flex lg:items-center lg:justify-between">
    <div class="flex-1 min-w-0">
      ...
      <h2
        class="mt-2 text-2xl font-bold leading-7 text-white sm:text-3xl sm:truncate"
      >
        Back End Developer
      </h2>
      <div
    ...
    <div class="mt-5 flex lg:mt-0 lg:ml-4">
      <span class="hidden sm:block">
        ...
        >
          <PencilIcon
            class="-ml-1 mr-2 h-5 w-5 text-gray-300"
            aria-hidden="true"
          />
          Edit
        </button>
      ...
      <Menu as="span" class="ml-3 relative sm:hidden">
        <MenuButton
          class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-700 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-indigo-500"
        >
          More
          <ChevronDownIcon
