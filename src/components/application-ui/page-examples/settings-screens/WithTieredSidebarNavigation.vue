...
<template>
  ...
  <div class="h-full flex">
            ...
            <div class="flex-shrink-0 flex border-t border-blue-gray-200 p-4">
              <a href="#" class="flex-shrink-0 group block">
                <div class="flex items-center">
                  ...
                  <div class="ml-3">
                    <p
                      class="text-base font-medium text-blue-gray-700 group-hover:text-blue-gray-900"
                    >
                      Lisa Marie
                    </p>
                    <p
                      class="text-sm font-medium text-blue-gray-500 group-hover:text-blue-gray-700"
                    >
                      Account Settings
                    </p>
                  </div>
    ...
    <div class="flex-1 min-w-0 flex flex-col overflow-hidden">
      ...
      <div class="lg:hidden">
        <div
          class="bg-blue-600 py-2 px-4 flex items-center justify-between sm:px-6"
        >
          <div>
            <img
              class="h-8 w-auto"
            ...
            <div class="flex-1 xl:overflow-y-auto">
              ...
              >
                ...
                <form class="mt-6 space-y-8 divide-y divide-y-blue-gray-200">
                  ...
                  <div
                    class="pt-8 grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6"
                  >
                    <div class="sm:col-span-6">
                      <h2 class="text-xl font-medium text-blue-gray-900">
